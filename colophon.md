/colophon&nbsp;&nbsp;&nbsp;&nbsp;[what is this?](https://slashpages.net/#colophon)&nbsp;&nbsp;&nbsp;&nbsp;[other slash pages](/slashes.md)
...
It is hosted on GitHub Pages at [johnmertz.github.io](https://johnmertz.github.io), however some features which are available via the address bar only work from [mer.tz](https://mer.tz) because of some URI rewriting via the [nginx](https://nginx.org) reverse proxy.
